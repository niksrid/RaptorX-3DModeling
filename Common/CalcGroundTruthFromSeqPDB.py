...
if __name__ == "__main__":
	if len(sys.argv) < 3:
		print 'python2 CalcGroundTruthFromSeqPDB.py structFile seqFile [resDir]'
		print '	This script calculates protein properties, distance and orientation matrices from a protein structure file and a sequence file'
		...
		print '		the resultant file is named after targetName.native.pkl where targetName is the basename of seqFile'
		exit(1)
	...
	savefile = os.path.join(resDir, protein['name'] + '.native.pkl')
