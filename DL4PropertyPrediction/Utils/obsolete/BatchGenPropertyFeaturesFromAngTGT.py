...
from GenPropertyFeaturesFromAngTGT import LoadTrainData4Properties

sys.path.append(os.path.join(os.environ['ModelingHome'], 'Common') )
from LoadTPLTGT import load_tgt as LoadTGT

## this script file generates training data from TGT files and Yujuan's angle files

def Usage():
	print 'python2 BatchGenPropertyFeaturesFromAngTGT.py proteinList tgt_dir angle_dir'
