...
Usage: python2 AddTemplateAndPropertyFeatures.py sequenceFeaturesPKL tplSimFeaturesPKL
...
"""
if len(sys.argv)<3:
	print 'python2 AddTemplatePropertyAndFeatures.py sequenceFeaturesPKL tplSimFeaturesPKL'
	exit(1)
