...
Usage: python2 AddTemplateAndDistanceFeatures.py originalDistanceFeaturesPKL tplSimFeaturesAtomPKL
...
"""
if len(sys.argv)<3:
	print 'python2 AddTemplateAndDistanceFeatures.py originalDistanceFeaturesPKLs tplSimFeaturesAtomPKLs'
	exit(-1)
